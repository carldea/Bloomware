...
import me.offeex.ofx.client.altmanager.screens.DeleteAccount;
...
public class DeleteAccountButton extends AbstractButton {
    ...
    Identifier trashCan = new Identifier("ofx", "icons/trashcan.png");
    Identifier trashCan2 = new Identifier("ofx", "icons/trashcanpress.png");

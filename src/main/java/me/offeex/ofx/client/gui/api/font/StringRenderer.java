package me.offeex.ofx.client.gui.api.font;
...
*/
    ...
    public int getStringWidth(String text, float fontsize)
    {
        ...
        GlyphVector vector = this.cache.glyphCache.usedFonts.get(0).deriveFont(fontsize).layoutGlyphVector(GlyphCache.fontRenderContext, chars, 0, chars.length, Font.LAYOUT_LEFT_TO_RIGHT);
